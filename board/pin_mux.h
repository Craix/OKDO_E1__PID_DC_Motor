 ...
 */
#define PIO1_27_MODE_PULL_DOWN 0x01u
/*!
 * @brief Select Digital mode.: Enable Digital mode. Digital input is enabled. */
...
/*! @name PIO1_1 (number 59), LCD_SSEL
  @{ */
#define LCD_SSEL_PORT 1U                  /*!<@brief PORT peripheral base pointer */
#define LCD_SSEL_PIN 1U                   /*!<@brief PORT pin number */
#define LCD_SSEL_PIN_MASK (1U << 1U)      /*!<@brief PORT pin mask */
                                          /* @} */

/*! @name PIO0_26 (number 60), LCD_MOSI
  @{ */
#define LCD_MOSI_PORT 0U                   /*!<@brief PORT peripheral base pointer */
#define LCD_MOSI_PIN 26U                   /*!<@brief PORT pin number */
#define LCD_MOSI_PIN_MASK (1U << 26U)      /*!<@brief PORT pin mask */
                                           /* @} */

/*! @name PIO1_2 (number 61), LCD_SCK
  @{ */
#define LCD_SCK_PORT 1U                  /*!<@brief PORT peripheral base pointer */
#define LCD_SCK_PIN 2U                   /*!<@brief PORT pin number */
#define LCD_SCK_PIN_MASK (1U << 2U)      /*!<@brief PORT pin mask */
                                         /* @} */
...
/* Symbols to be used with GPIO driver */
#define LCD_RST_GPIO GPIO                 /*!<@brief GPIO peripheral base pointer */
#define LCD_RST_GPIO_PIN_MASK (1U << 26U) /*!<@brief GPIO pin mask */
#define LCD_RST_PORT 1U                   /*!<@brief PORT peripheral base pointer */
#define LCD_RST_PIN 26U                   /*!<@brief PORT pin number */
#define LCD_RST_PIN_MASK (1U << 26U)      /*!<@brief PORT pin mask */
                                          /* @} */
...
/* Symbols to be used with GPIO driver */
#define LCD_DC_GPIO GPIO                 /*!<@brief GPIO peripheral base pointer */
#define LCD_DC_GPIO_PIN_MASK (1U << 27U) /*!<@brief GPIO pin mask */
#define LCD_DC_PORT 1U                   /*!<@brief PORT peripheral base pointer */
#define LCD_DC_PIN 27U                   /*!<@brief PORT pin number */
#define LCD_DC_PIN_MASK (1U << 27U)      /*!<@brief PORT pin mask */
                                         /* @} */
...
/*! @name PIO1_10 (number 40), DC_PWM
  @{ */
#define DC_MOTOR_PWM_PORT 1U                   /*!<@brief PORT peripheral base pointer */
#define DC_MOTOR_PWM_PIN 10U                   /*!<@brief PORT pin number */
#define DC_MOTOR_PWM_PIN_MASK (1U << 10U)      /*!<@brief PORT pin mask */
                                               /* @} */

/*! @name PIO1_8 (number 24), DC_DATA
  @{ */

/* Symbols to be used with GPIO driver */
#define DC_MOTOR_DATA_GPIO GPIO                /*!<@brief GPIO peripheral base pointer */
#define DC_MOTOR_DATA_GPIO_PIN_MASK (1U << 8U) /*!<@brief GPIO pin mask */
#define DC_MOTOR_DATA_PORT 1U                  /*!<@brief PORT peripheral base pointer */
#define DC_MOTOR_DATA_PIN 8U                   /*!<@brief PORT pin number */
#define DC_MOTOR_DATA_PIN_MASK (1U << 8U)      /*!<@brief PORT pin mask */
                                               /* @} */
...
/* Symbols to be used with GPIO driver */
#define DC_MOTOR_CLK_GPIO GPIO                /*!<@brief GPIO peripheral base pointer */
#define DC_MOTOR_CLK_GPIO_PIN_MASK (1U << 9U) /*!<@brief GPIO pin mask */
#define DC_MOTOR_CLK_PORT 1U                  /*!<@brief PORT peripheral base pointer */
#define DC_MOTOR_CLK_PIN 9U                   /*!<@brief PORT pin number */
#define DC_MOTOR_CLK_PIN_MASK (1U << 9U)      /*!<@brief PORT pin mask */
                                              /* @} */

/*! @name PIO1_5 (number 31), DC_AIN1
  @{ */

/* Symbols to be used with GPIO driver */
#define DC_MOTOR_AIN2_GPIO GPIO                /*!<@brief GPIO peripheral base pointer */
#define DC_MOTOR_AIN2_GPIO_PIN_MASK (1U << 5U) /*!<@brief GPIO pin mask */
#define DC_MOTOR_AIN2_PORT 1U                  /*!<@brief PORT peripheral base pointer */
#define DC_MOTOR_AIN2_PIN 5U                   /*!<@brief PORT pin number */
#define DC_MOTOR_AIN2_PIN_MASK (1U << 5U)      /*!<@brief PORT pin mask */
                                               /* @} */

/*! @name PIO0_15 (number 22), DC_AIN2
  @{ */

/* Symbols to be used with GPIO driver */
#define DC_MOTOR_AIN1_GPIO GPIO                 /*!<@brief GPIO peripheral base pointer */
#define DC_MOTOR_AIN1_GPIO_PIN_MASK (1U << 15U) /*!<@brief GPIO pin mask */
#define DC_MOTOR_AIN1_PORT 0U                   /*!<@brief PORT peripheral base pointer */
#define DC_MOTOR_AIN1_PIN 15U                   /*!<@brief PORT pin number */
#define DC_MOTOR_AIN1_PIN_MASK (1U << 15U)      /*!<@brief PORT pin mask */
                                                /* @} */

/*! @name PIO1_9 (number 10), DC_CLK
  @{ */
#define DC_MOTOR_CLK_INT_PORT 1U                  /*!<@brief PORT peripheral base pointer */
#define DC_MOTOR_CLK_INT_PIN 9U                   /*!<@brief PORT pin number */
#define DC_MOTOR_CLK_INT_PIN_MASK (1U << 9U)      /*!<@brief PORT pin mask */
                                                  /* @} */
 ...
 *
 */
void DC_MOTOR(void); /* Function assigned for the Cortex-M33 (Core #0) */
...
/*! @name PIO0_7 (number 6), ENC_INC_DATA
  @{ */

/* Symbols to be used with GPIO driver */
#define ENC_INC_DATA_GPIO GPIO                /*!<@brief GPIO peripheral base pointer */
#define ENC_INC_DATA_GPIO_PIN_MASK (1U << 7U) /*!<@brief GPIO pin mask */
#define ENC_INC_DATA_PORT 0U                  /*!<@brief PORT peripheral base pointer */
#define ENC_INC_DATA_PIN 7U                   /*!<@brief PORT pin number */
#define ENC_INC_DATA_PIN_MASK (1U << 7U)      /*!<@brief PORT pin mask */
                                              /* @} */

/*! @name PIO1_0 (number 11), ENC_INC_CLK
  @{ */

/* Symbols to be used with GPIO driver */
#define ENC_INC_CLK_GPIO GPIO                /*!<@brief GPIO peripheral base pointer */
#define ENC_INC_CLK_GPIO_PIN_MASK (1U << 0U) /*!<@brief GPIO pin mask */
#define ENC_INC_CLK_PORT 1U                  /*!<@brief PORT peripheral base pointer */
#define ENC_INC_CLK_PIN 0U                   /*!<@brief PORT pin number */
#define ENC_INC_CLK_PIN_MASK (1U << 0U)      /*!<@brief PORT pin mask */
                                             /* @} */

/*! @name PIO0_31 (number 23), ENC_INC_SW
  @{ */

/* Symbols to be used with GPIO driver */
#define ENC_INC_SW_GPIO GPIO                 /*!<@brief GPIO peripheral base pointer */
#define ENC_INC_SW_GPIO_PIN_MASK (1U << 31U) /*!<@brief GPIO pin mask */
#define ENC_INC_SW_PORT 0U                   /*!<@brief PORT peripheral base pointer */
#define ENC_INC_SW_PIN 31U                   /*!<@brief PORT pin number */
#define ENC_INC_SW_PIN_MASK (1U << 31U)      /*!<@brief PORT pin mask */
                                             /* @} */

/*! @name PIO1_0 (number 11), ENC_INC_CLK
  @{ */
#define ENC_INC_CLK_INT_PORT 1U                  /*!<@brief PORT peripheral base pointer */
#define ENC_INC_CLK_INT_PIN 0U                   /*!<@brief PORT pin number */
#define ENC_INC_CLK_INT_PIN_MASK (1U << 0U)      /*!<@brief PORT pin mask */
                                                 /* @} */

/*! @name PIO0_31 (number 23), ENC_INC_SW
  @{ */
#define ENC_INC_SW_INT_PORT 0U                   /*!<@brief PORT peripheral base pointer */
#define ENC_INC_SW_INT_PIN 31U                   /*!<@brief PORT pin number */
#define ENC_INC_SW_INT_PIN_MASK (1U << 31U)      /*!<@brief PORT pin mask */
                                                 /* @} */
 ...
 *
 */
void ENC_INC(void); /* Function assigned for the Cortex-M33 (Core #0) */
